...
border:1px black solid;
 ...
 <% 
	...
	String product_prices=request.getParameter("product_price");
	...
	System.out.println("cartPay_check.jsp String="+cart_idxs);
	int cart_idx=Integer.parseInt(cart_idxs);
	System.out.println("cartPay_check.jsp int="+cart_idx);
...
<article>
<h4>결제 확인 창입니다.</h4>
<form name="pay_check" action="cartpay_complete.jsp">
<table>
<tr>
<th>회원아이디: </th>
<td><%=member_id %></td>
...
<input type="hidden" name="payment_totalprice" value="<%=product_price%>">
