<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" type="text/css" href="/semi_project/css/aside/aside.css">
<%
...
%>
		<aside>
			<ul id="navigation">
		       ...
		       <li class="about"><div><a href="/semi_project/section/member/mypage.jsp" title="내정보보기"><img src="/semi_project/img/icon/icon_brand_cate.png"><p>내정보보기</p></a></div></li>
		       <li class="search"><div><a href="" title="Search"><img src="/semi_project/img/icon/icon_brand_cate.png"><p>이벤트</p></a></div></li>
